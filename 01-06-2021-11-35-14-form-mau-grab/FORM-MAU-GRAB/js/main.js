 ...
 * *Xử lý
 * - function layLoaiXe()
 *      + Dom tới 3 thẻ input của LoaiXe: radioGrabX, radioGrabSuv, radioGrabBlack
 ...
 *      + Gọi lại hàm layLoaiXe => nhận lại giá trị là loại xe nào
 *      + switch
 *          case "grabX":
 *
 *          case "grabSuv" :
 ...
 *      if(tgCho >= 3) return Math.floor(tgCho / 3)*giaCho
 */
...
document.getElementById("btnTinhTien").onclick = function () {
    ...
    //dấu ! để phủ định lại đk nếu user chọn loại xe thfi đúng,ko chọn thì alert
    if (!loaiXe) {
    ...
    switch (loaiXe) {
        ...
        case "grabSUV":
            tinhChiTiet(soKm, tgCho, GRABSUV_WAIT, GRABSUV_1, GRABSUV_2, GRABSUV_3);
            break;

        case "grabBlack":
            tinhChiTiet(soKm, tgCho, GRABBLACK_WAIT, GRABBLACK_1, GRABBLACK_2, GRABBLACK_3);
            break;
...
function layLoaiXe() {
    ...
    //Nếu user ko chọn loại xe sẽ trả về KQ là null
    return null;
}
